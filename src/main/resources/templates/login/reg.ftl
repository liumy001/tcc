                    ...
                    <div class="form-bottom">
                        <form role="form" action="" method="post" class="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nickName" placeholder="请输入昵称" class="form-password form-control" id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">邮箱</label>
                                <input type="email" name="email" placeholder="请输入邮箱" class="form-password form-control" id="form-username">
                            </div>
